...
\\
%\subsubsection{Métricas baseadas em questões}
%\label{sec:metricas-questoes}
...
%	barnum:01: fazer análise quantitativa das questões de %usabilidade; tomar cuidado com conflito entre dados subjetivos e objetivos; reunir também as críticas positivas
